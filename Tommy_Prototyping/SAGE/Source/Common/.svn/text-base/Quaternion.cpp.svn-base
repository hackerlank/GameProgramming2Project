/// \file Quaternion.cpp
/// \brief Code for the Quaternion class.
...
void    Quaternion::setToRotateAboutAxis(const Vector3 &axis, float theta) {
	...
	assert(fabs(axis.magnitude() - 1.0f) < .01f);
...
/// \param orientation Represents the rotation in Euler angle form.
...
/// \return A reference to this now-modified quaternion.
...
float Quaternion::dotProduct(const Quaternion &a) const {
...
Quaternion Quaternion::crossProduct(const Quaternion &a) const {
	Quaternion result;
...
/// \param q0 Specifies the initial quaternion.
/// \param q1 Specifies the final quaternion.
/// \param t Specifies the parametric time.
/// \return The interpolated quaternion at the given time.
Quaternion slerp(const Quaternion &q0, const Quaternion &q1, float t) {
	...
	float cosOmega = Quaternion::dotProduct(q0, q1);
...
/// \return The quaternion raised to the exponent.
Quaternion Quaternion::pow(float exponent) const {
